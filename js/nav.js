...
(function () {
  ...
  <nav id="site-nav" class="site-nav">
    <div class="nav-inner">
      ...
      <div class="nav-links" id="nav-links">
        ...
        <a href="explore.html"        class="nav-link ${isActive('explore.html')}">Explore</a>
        ...
        <a href="guides.html"         class="nav-link ${isActive('guides.html')}">Guides</a>
        ...
        <a href="ai-travel.html" class="nav-ai-pill ${isActive('ai-travel.html')}">
          ...
          <span class="ai-chip-label">Atlas</span>
          <span class="ai-chip-tag">Trip Architect</span>
        </a>
      </div>
  ...
  /* ✅ PERMANENT WHITE GLASS: sirf shadow + padding polish on scroll, NO navy flip */
  .site-nav.scrolled {
  ...
  .site-nav.scrolled .nav-logo-img {
    filter: drop-shadow(0 2px 14px rgba(11,31,58,0.18));
  }
  ...
  .nav-wish-badge {
    ...
    padding: 0 5px;
    box-shadow: 0 3px 10px rgba(244,162,97,0.5);
